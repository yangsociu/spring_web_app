...
import { Camera, Upload, User, Mail, Code, Calendar, Edit3 } from "lucide-react"
      ...
      <Card className="shadow-sm border-0 bg-gradient-to-br from-green-50 to-emerald-50">
        ...
        <CardContent>
          <div className="animate-pulse space-y-6">
            <div className="w-32 h-32 bg-green-200 rounded-full mx-auto"></div>
        ...
        <CardContent className="p-8 space-y-8">
          <div className="flex flex-col items-center space-y-6">
            <div className="relative group">
              ...
              <Avatar className="relative w-32 h-32 border-4 border-white shadow-2xl ring-4 ring-green-100">
                <AvatarImage
                  src={previewUrl || user?.avatarUrl || ""}
                  alt={user?.fullName || "User avatar"}
                  className="object-cover"
                />
                <AvatarFallback className="bg-gradient-to-br from-green-100 to-emerald-100 text-green-600 text-3xl font-bold">
                  {user?.fullName?.charAt(0) || user?.email?.charAt(0) || "U"}
                </AvatarFallback>
              </Avatar>
              <button
                onClick={handleAvatarClick}
                className="absolute -bottom-2 -right-2 w-12 h-12 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white rounded-full flex items-center justify-center shadow-xl transition-all duration-200 transform hover:scale-110 group"
              >
            ...
            {selectedFile && !showCropper && (
              <div className="text-center space-y-3 p-4 bg-white rounded-xl shadow-sm border border-green-100">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  value={user?.fullName || ""}
                  readOnly
                  className="bg-green-50 border-green-200 focus:border-green-400 h-12"
                />
              </div>
